			...
			function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller) {
				...
				var privateMethods = {
					...
					closeDialog: function ($dialog, value) {
						/*Fix notication && request friend*/
						if ($rootScope.NotificationIsOpen || $rootScope.RequestFriendIsOpen ) {
							animationEndSupport = false;
						};
						$rootScope.RequestFriendIsOpen = false;
						$rootScope.NotificationIsOpen = false;												
						/*end fix*/
